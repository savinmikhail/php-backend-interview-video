...
- Фрагмент source-time: `00:00–00:00`.
- Фрагмент review-time: `00:00–00:00`.
- Говорящие: `...`.
...
| Состояние | Source-time | Review-time | Что звучит | Функция экрана | Паттерн |
|---|---|---|---|---|---|
| 1 | 00:00–00:00 | 00:00–00:00 | … | удержать вопрос | Question |
| 2 | 00:00–00:00 | 00:00–00:00 | … | показать механизм | CodeWithTakeaways |
...
- К какой реплике привязано: source `00:00`, review `00:00`.
...
- [ ] Таймкоды сверены с транскриптом и указаны в обеих шкалах.
- [ ] Review-time пересчитан CLI, принятый интервал добавлен в
      `video/review-timing-locks.tsv`.
- [ ] Границы проверены через `npm run render:timing -- SLIDE_ID` в полной
      review-композиции.
