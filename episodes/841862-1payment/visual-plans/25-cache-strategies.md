...
| 2 | `53:41–53:59` | разделить два класса стратегий |
| 3 | `53:59–54:14` | исправить Cache Aside |
| 4 | `54:14–54:50` | сравнить write-through и write-behind |
| 5 | `54:50–55:21` | показать consistency/reliability trade-off |

```mermaid
flowchart LR
  Q["1 · Вопрос"] --> C["2 · Что выбираем"] --> A["3 · Cache Aside"] --> W["4 · Write strategies"] --> T["5 · Trade-off"]
```
...
## Состояние 2 — не смешивать стратегии
...
## Состояние 4 — две write-стратегии
...
## Состояние 5 — выбор по требованиям
