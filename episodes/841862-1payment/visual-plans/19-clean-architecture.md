...
| № | Таймкод | Функция |
|---|---|---|
| 1 | `44:05–45:03` | удержать вопрос во время паузы и сбивок |
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 19/58  Что такое чистая архитектура?                         │
├──────────────────────────────────────────────────────────────┤
│                                                              │
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 19/58  Зависимости направлены к бизнес-правилам              │
├──────────────────────────────────────────────────────────────┤
│ Framework ─┐                                                 │
