...
Монтаж: `ИСКЛЮЧЁН ИЗ ФИНАЛЬНОЙ REVIEW-СБОРКИ` — пользователь решил убрать
вопрос про AI вместе с нетехническим финальным разговором.
...
- Весь этот диапазон попадает в принятый source-вырез
  `01:17:49–01:21:53`; состояния ниже сохранены только как архив принятого
  дизайна и не подключены к активному таймлайну.
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 32/32  Как ты используешь AI в разработке?                  │
├──────────────────────────────────────────────────────────────┤
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 32/32  Сгенерированный код — ещё не принятый код             │
├─────────────────────────────┬────────────────────────────────┤
│ PROMPT                      │ OUTPUT                         │
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 32/32  Хороший результат должен быть понятен человеку        │
├─────────────────────────────┬────────────────────────────────┤
