...
Это один короткий вопрос с одним ответом. Счётчик выпуска: `04/58`; общий
знаменатель пока не пересчитываем.
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 04/58  DateTimeImmutable и DateTime — в чём разница?         │
├──────────────────────────────┬───────────────────────────────┤
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 04/58  DateTimeImmutable возвращает новый объект             │
├──────────────────────────────┬───────────────────────────────┤
