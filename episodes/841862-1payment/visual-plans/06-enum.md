...
|---|---|---|---|---|
| 1. Вопрос и пример | 20:59–21:10 | вопрос про назначение `enum` | оставить вопрос в header и почти сразу раскрыть два кейса без отдельного мелькающего question-slide | Code comparison |
