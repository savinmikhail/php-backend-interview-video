...
а не два самостоятельных вопроса. Счётчик выпуска: `05/58`.
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 05/58  Исключение должно сообщать смысл сбоя                 │
├──────────────────────────────┬───────────────────────────────┤
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 05/58  Ловим там, где можем принять решение                  │
│                                      Уточнение ответа         │
├──────────────────────────────────────────────────────────────┤
│ Payment provider                                             │
│ GatewayTimeout                                               │
