...
| № | Таймкод | Функция |
|---|---|---|
| 1 | `44:11–45:12` (`29:13–29:41` review) | удержать вопрос непрерывно через монтажную склейку |
| 2 | `45:12–45:42` (`29:41–30:11` review) | показать dependency rule и независимое ядро |
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 19/30  Что такое чистая архитектура?                         │
├──────────────────────────────────────────────────────────────┤
│                                                              │
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 19/30  Зависимости направлены к бизнес-правилам              │
├──────────────────────────────────────────────────────────────┤
│ Framework ─┐                                                 │
