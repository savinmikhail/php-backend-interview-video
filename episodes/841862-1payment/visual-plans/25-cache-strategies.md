...
```text
┌──────────────────────────────────────────────────────────────┐
│ 25/32  Четыре паттерна — два разных вопроса                  │
├─────────────────────────────┬────────────────────────────────┤
...
Код остаётся видимым целиком, справа за первую секунду появляются три шага
execution trace; соответствующая строка кода кратко подсвечивается цветом шага
и затем возвращается к нейтральному фону.
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 25/32  Выбор стратегии — баланс трёх требований              │
├──────────────────────────────────────────────────────────────┤
│                          Freshness                           │
│                     stale допустим?                          │
│                            ╱  ╲                              │
