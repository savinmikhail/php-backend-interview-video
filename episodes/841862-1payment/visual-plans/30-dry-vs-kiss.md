...
- `transcription.txt`, `1:00:57–1:02:32` source-time.
- Принятые границы в review-time: `45:14–46:49`.
...
|---|---|---|---|
| 1 | `1:00:57–1:01:10` | `45:14–45:27` | определить два принципа |
| 1a | `1:01:10–1:01:18` | `45:27–45:35` | карточка «Противоречит ли KISS и DRY?» |
| 2 | `1:01:18–1:01:48` | `45:35–46:05` | показать ложное объединение похожего кода |
| 3 | `1:01:48–1:02:32` | `46:05–46:49` | дать критерий выбора |

```mermaid
flowchart LR
  D["1 · DRY / KISS"] --> Q["1a · Противоречат?"] --> A["2 · Premature abstraction"] --> C["3 · Change together?"]
```
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 30/30  DRY и KISS отвечают на разные риски                   │
├─────────────────────────────┬────────────────────────────────┤
│ DRY                         │ KISS                           │
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 30/30  Похожий код ещё не означает общую abstraction        │
├─────────────────────────────┬────────────────────────────────┤
