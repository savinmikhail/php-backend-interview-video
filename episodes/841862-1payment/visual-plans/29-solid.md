...
- `transcription.txt`, `58:09–1:00:57` source-time.
- Принятые границы в review-time: `42:26–45:14`.
...
|---|---|---|---|
| 0 | `58:09–58:16` | `42:26–42:33` | карточка «Что такое SOLID» |
| 1 | `58:16–58:48` | `42:33–43:05` | SOLID + SRP/OCP |
| 2 | `58:48–59:35` | `43:05–43:52` | LSP и исправление про сигнатуру |
| 3 | `59:35–1:00:14` | `43:52–44:31` | ISP/DIP без лишней лекции |
| 3a | `1:00:14–1:00:18` | `44:31–44:35` | карточка «Является SOLID всегда обязательным правилом?» |
| 4 | `1:00:18–1:00:57` | `44:35–45:14` | принципы не являются обязательным ритуалом |

```mermaid
flowchart LR
  Q["0 · Что такое SOLID"] --> SO["1 · S / O"] --> L["2 · LSP"] --> ID["3 · I / D"] --> R["3a · Обязательное правило?"] --> T["4 · Trade-off"]
```
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 29/30  SOLID · эвристики управления изменениями              │
├─────────────────────────────┬────────────────────────────────┤
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 29/30  L · Подтип сохраняет обещания базового типа           │
├──────────────────────────────────────────────────────────────┤
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 29/30  SOLID не обязателен «на максимум»                     │
├─────────────────────────────┬────────────────────────────────┤
│ ПОЛЬЗА                      │ ЦЕНА                           │
