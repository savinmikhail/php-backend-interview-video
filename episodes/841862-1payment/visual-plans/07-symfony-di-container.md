...
|---|---|---|---|---|
| Базовый экран | 21:21–21:37 | переход к Symfony и вводная интервьюера | сохранить разговор без преждевременного вопроса | Base scene |
| 1. Вопрос | 21:37–21:42 | формулировка вопроса | удержать составной вопрос | Question |
...
```mermaid
flowchart LR
  B["Переход · фон + аватары"] --> S1["1 · Вопрос"]
  S1 --> S2["2 · Object graph"]
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 07/30  Как работает DI-контейнер Symfony?                    │
├──────────────────────────────┬───────────────────────────────┤
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 07/30  Компилировать заранее или разрешать в runtime?        │
├──────────────────────────────┬───────────────────────────────┤
│ SYMFONY                      │ YII DI                        │
