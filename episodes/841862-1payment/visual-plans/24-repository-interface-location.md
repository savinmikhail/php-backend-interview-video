...
| № | Таймкод | Функция |
|---|---|---|
| 1 | `52:42–53:01` | показать вопрос и две возможные внутренние зоны |
| 2 | `53:01–53:19` | показать dependency inversion и вывод |

```mermaid
flowchart LR
  Q["1 · Domain или Application?"] --> O["2 · Интерфейс у потребителя"]
```
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 24/58  Где должен жить Repository interface?                │
├─────────────────────────────┬────────────────────────────────┤
│ Domain                      │ Application                    │
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 24/58  Интерфейс принадлежит внутренней стороне              │
├──────────────────────────────────────────────────────────────┤
